/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e888cd263353006ecdd63dcf69b4505d)
...
interface __BaseEnv_Env {
	...
	Y_DURABLE_OBJECTS: DurableObjectNamespace<import("./src/worker/index").PageRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "PageRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BETTER_AUTH_SECRET">> {}
}
